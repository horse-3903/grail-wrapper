...
then commit and push (or redeploy) `web/`. `web/index.html` is generated from `static/index.html`
by `python build_web.py` - edit `static/index.html` and re-run that after any UI change, rather
than editing `web/index.html` directly.
...
├── build_web.py               # generates web/index.html from static/index.html
├── static/
│   ├── index.html               # local-server UI - the single source of truth, edit this one
│   ├── drive-icon.png            # source badge: Google Drive
│   └── link-icon.png             # source badge: direct grail.moe link
├── web/
│   ├── index.html                # static build, generated by build_web.py - don't hand-edit
